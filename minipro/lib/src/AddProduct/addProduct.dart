                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Obx(
                          () {
                            return AddProductController.image.isNotEmpty
                                ? ListView.builder(
                                    scrollDirection: Axis.horizontal,
                                    itemCount:
                                        AddProductController.image.length,
                                    itemBuilder: (context, index) {
                                      return Container(
                                        ...
                                        height: 100,
                                        child: Image.file(
                                          AddProductController.image[index],
                                          fit: BoxFit.cover,
                                        ),
                                      );
                                    },
                        ...
                        showDialog(
                          ...
                          builder: (BuildContext context) {
                            return AlertDialog(
                              ...
                              content: Text(
                                  'คุณแน่ใจหรือไม่ที่ต้องการล้างข้อมูลทั้งหมด?'),
                              actions: <Widget>[
                                TextButton(
                                  onPressed: () {
                                    // ปิด Dialog
